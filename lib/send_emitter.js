...
function SendEmitter (stream) {
	...
	this.session = {}
	this.on('_set', this._set.bind(this))

	// Attach stream, if given
	stream && this.attach(stream)
}
 ...
 * 
 * @param {mixed} key [If string, replace named object with val, otherwise replace structure]
 * @param {mixed} val [Value to replace with, assuming key is a string]
 */
