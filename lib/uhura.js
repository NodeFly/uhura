 ...
 * Create uhura client
 * 
 * @param {mixed}       [port] [Port, as number or string, to use in tls.connect]
 * @param {string}      [host] [Optional host name to use in tls.connect]
 * @return {tls.Socket}        [Client emitter]
 */
 ...
 * @return {tls.Socket}           [TLS server to use, not yet listening]
 */
